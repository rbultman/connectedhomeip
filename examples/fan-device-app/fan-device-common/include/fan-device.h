...
#include <app/clusters/fan-control-server/fan-control-cluster-logic.h>
...
class FanControlClusterDriver : public FanControl::FanControlClusterLogic::DriverInterface {
    // TODO: Add cluster driver here
};

class ExampleFanDevice : public FanControl::Delegate,
...
public:
     ...
     */
    explicit ExampleFanDevice(EndpointId aClustersEndpoint) :
        mOperationalStateInstance(this, aClustersEndpoint),
        mFanModeInstance(this, aClustersEndpoint, FanMode::Id, 0),
        mFanControlInstance(this, aClustersEndpoint, FanControl::Id,
                                      BitMask<FanControl::Feature>(FanControl::Feature::kPowerAsNumber,
                                                                             FanControl::Feature::kPowerNumberLimits),
                                      mOperationalStateInstance, mFanModeInstance)
    {}
    ...
    // delegates from FanControl cluster
    /**
...
private:
    ...
    ModeBase::Instance mFanModeInstance;
    FanControl::Instance mFanControlInstance;
    ...
    // FanMode types
    ModeTagStructType modeTagsNormal[1]  = { { .value = to_underlying(FanMode::ModeTag::kNormal) } };
    ModeTagStructType modeTagsDefrost[1] = { { .value = to_underlying(FanMode::ModeTag::kDefrost) } };
