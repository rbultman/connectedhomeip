...
-   Build the example application:
          ...
          $ cd ~/connectedhomeip/examples/fan-device/linux
...
-   To delete generated executable, libraries and object files use:
          ...
          $ cd ~/connectedhomeip/examples/fan-device-app/linux
          $ rm -rf out/
...
-   Running
    ...
    -   [Optional] Plug USB Bluetooth dongle
        ...
        -   Run Linux Lighting Example App
                  ...
                  $ cd ~/connectedhomeip/examples/fan-device-app/linux
                  $ sudo out/debug/chip-fan-device-app --ble-device [bluetooth device number]
                  # In this example, the device we want to use is hci1
                  $ sudo out/debug/chip-fan-device-app --ble-device 1
