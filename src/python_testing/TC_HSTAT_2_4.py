...
class TC_HSTAT_2_4(HSTATBase):
    ...
    async def test_TC_HSTAT_2_4(self):
        ...
        if self.continuousFeatureSupported:
            ...
            continuousSubscription.cancel()  # pyright: ignore[reportPossiblyUnboundVariable]
        else:
        ...
        if self.attributes.Sleep.attribute_id in self.supported_attributes:
            ...
            sleepSubscription.cancel()  # pyright: ignore[reportPossiblyUnboundVariable]
        else:
        ...
        if self.optimalFeatureSupported:
            ...
            optimalSubscription.cancel()  # pyright: ignore[reportPossiblyUnboundVariable]
        else:
